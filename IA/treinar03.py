...
# Descubra quantas camadas tem a base -- útil para calibrar o fine-tuning depois
print(f"Total de camadas no ResNet50V2: {len(base_model.layers)}")
...
for layer in base_model.layers[:-40]:  # ResNet50V2 é mais profunda, descongela uma fatia maior
...
# Novo EarlyStopping para a Fase 2, sem herdar o estado da Fase 1
...
# ----------------------------
model.save("classificador_latinha03.keras")
print("Modelo salvo como classificador_latinha03.keras")