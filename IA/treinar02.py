...
for layer in base_model.layers[:-30]:  # mantém a maior parte congelada
...
# ----------------------------
model.save("classificador_latinha02.keras")
print("Modelo salvo como classificador_latinha02.keras")