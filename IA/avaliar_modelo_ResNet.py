...
IMG_SIZE = (224, 224)
BATCH_SIZE = 16
DATASET_DIR = r"C:\Users\pdv\Downloads\SicraiIA\SicraiIA\dataset"
MODEL_PATH = "classificador_latinha03.keras"
...
def avaliar_modelo():
    ...
    fig.tight_layout()
    fig.savefig("matriz_confusao03.png", dpi=150)
    print("\nImagem da matriz de confusão salva como 'matriz_confusao03.png'")
